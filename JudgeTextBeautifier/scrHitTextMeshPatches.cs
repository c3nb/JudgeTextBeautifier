...
{
    [HarmonyPatch(typeof(scrHitTextMesh))]
    public static class scrHitTextMeshPatches
    {
        [HarmonyPatch("Show")]
        [HarmonyPrefix]
        public static bool SPrefix(scrHitTextMesh __instance, Vector3 position, float angle, ref int ___frameShown, ref float ___timer, ref Renderer ___meshRenderer, ref Vector3 ___textPos)
        {
